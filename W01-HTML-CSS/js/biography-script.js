function darkMode() {
	...
	document.getElementById("hobby1").style.filter="invert(100%)";
	document.getElementById("hobby2").style.filter="invert(100%)";
	document.getElementById("hobby3").style.filter="invert(100%)";
...
function lightMode() {
	...
	document.getElementById("hobby1").style.filter="invert(0)";
	document.getElementById("hobby2").style.filter="invert(0)";
	document.getElementById("hobby3").style.filter="invert(0)";
